...
<body>
	    ...
	    String deleteSql = "DELETE FROM processquotation WHERE id=?";
	    ...
	    if (deleteResult > 0) {
	        ...
	        String selectSql = "SELECT id FROM processquotation ORDER BY id";
	        Statement selectStmt = con.createStatement();
	        ResultSet selectResult = selectStmt.executeQuery(selectSql);

	        // Update the srNo values starting from 1
	        int newSrNo = 1;
	        String updateSql = "UPDATE processquotation SET id=? WHERE id=?";
	        ...
	        out.println("window.location.href='" + request.getContextPath() + "/appliedProcessVendor.jsp';");
	        out.println("</script>");
	    }
	%>
