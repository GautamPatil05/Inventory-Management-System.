...
<body>
	    ...
	    // Selecting qid
	    String sql4 = "SELECT * FROM processquotation WHERE id=?";
	   ...
	   // getQid.setString(2,"raw");
	    ...
	    String deleteSql = "UPDATE processquotation SET status=? WHERE id=?";
	    ...
	    if (i > 0) {
	    	...
	    	String sql3 = "SELECT quantity FROM processmaterial where srNo=?";
	    	...
	    	String sql2 = "UPDATE processmaterial SET quantity=? WHERE srNo=?";
	        ...
	        out.println("window.location.href='" + request.getContextPath() + "/reqQuotationProcess.jsp';");
	        out.println("</script>");
