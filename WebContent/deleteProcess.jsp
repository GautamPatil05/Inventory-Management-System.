...
<body>
	    ...
	    String deleteSql = "DELETE FROM processmaterial WHERE srNo=?";
	    ...
	    if (deleteResult > 0) {
	        ...
	        String selectSql = "SELECT srNo FROM processmaterial ORDER BY srNo";
	        Statement selectStmt = con.createStatement();
	        ResultSet selectResult = selectStmt.executeQuery(selectSql);

	        // Update the srNo values starting from 1
	        int newSrNo = 1;
	        String updateSql = "UPDATE processmaterial SET srNo=? WHERE srNo=?";
	        ...
	        out.println("window.location.href='" + request.getContextPath() + "/viewProcess.jsp';");
	        out.println("</script>");
