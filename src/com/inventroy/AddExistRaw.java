...
public class AddExistRaw extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String updateQuantity = "UPDATE rawmaterial SET quantity=? WHERE name=?";
		...
		int i = pstmt2.executeUpdate();
		 ...
		 if (i > 0) {
		        ...
		        out.println("window.location.href='" + request.getContextPath() + "/addExistRaw.jsp';");
		        out.println("</script>");
		    } else {
